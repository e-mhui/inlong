...
/**
 * Test for {@link BinaryFormatInfo} and {@link FlinkSqlParser}
 */
public class BinaryFormatSqlParseTest extends AbstractTestBase {

    private KafkaExtractNode buildKafkaExtractNode() {
        List<FieldInfo> fields = Arrays.asList(new FieldInfo("id", new LongFormatInfo()),
                new FieldInfo("salary", new BinaryFormatInfo(2)));
    ...
    private KafkaLoadNode buildKafkaLoadNode() {
        ...
        List<FieldRelation> relations = Arrays
                .asList(new FieldRelation(new FieldInfo("id", new LongFormatInfo()),
                        ...
                        new FieldRelation(new FieldInfo("salary", new BinaryFormatInfo(2)),
                                new FieldInfo("salary", new BinaryFormatInfo(2)))
                );
    ...
    /**
     * Test precision for {@link BinaryFormatInfo}
     *
     * @throws Exception The exception may throws when executing
     */
    @Test
    public void testBinaryFormatSqlParse() throws Exception {
